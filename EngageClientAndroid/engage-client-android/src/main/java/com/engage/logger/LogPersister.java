...
public final class LogPersister {
  ...
  //  private static final String LOG_UPLOADER_PATH = "/analytics-service/rest/data/events/clientlogs/";
    private static final String LOG_UPLOADER_PATH = "/events/sessionActivity";
    ...
    private static class UncaughtExceptionHandler implements Thread.UncaughtExceptionHandler
    {
        ...
        public final void uncaughtException(final Thread t, final Throwable e)
        {
            ...
            EngageAnalyticsActivityLifecycleListener.getInstance().logAppCrash();
    ...
    protected static JSONObject appendStackMetadata(JSONObject additionalMetadata) {
        ...
        try {
            ...
            while(stackTraceElements[index].getClassName().equals (LogPersister.class.getName())
                    ...
                    || stackTraceElements[index].getClassName().startsWith (EngageAnalytics.class.getName())) {
                index++;
            }
    ...
    private synchronized static void sendFiles(String fileName, ResponseListener listener) {
        ...
        for (int i = LogPersister.MAX_NUM_LOG_FILES - 1; i > -1; i--) {
            ...
            if (EngageAnalytics.overrideServerHost != null){
                appRoute = EngageAnalytics.overrideServerHost;
            }
            ...
            if(EngageAnalytics.getClientApiKey() != null && !EngageAnalytics.getClientApiKey().equalsIgnoreCase("")){
                sendLogsRequest.addHeader("x-mfp-analytics-api-key", EngageAnalytics.getClientApiKey());
            }
            else{
