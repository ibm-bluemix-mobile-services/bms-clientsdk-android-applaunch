...
public class NetworkLoggingInterceptor implements Interceptor{
    @Override public Response intercept(Chain chain) throws IOException {
        ...
        if(EngageAnalytics.getClientApiKey() != null && !EngageAnalytics.getClientApiKey().equalsIgnoreCase("")){
            ...
            requestWithHeadersBuilder.addHeader("x-mfp-analytics-api-key", EngageAnalytics.getClientApiKey());
        }
        ...
        if(EngageAnalytics.isRecordingNetworkEvents){
    ...
    protected JSONObject generateRoundTripRequestAnalyticsMetadata(Request request, long startTime, String trackingID, Response response) throws IOException {
        ...
        try {
            ...
            metadata.put(EngageAnalytics.CATEGORY, "network");
