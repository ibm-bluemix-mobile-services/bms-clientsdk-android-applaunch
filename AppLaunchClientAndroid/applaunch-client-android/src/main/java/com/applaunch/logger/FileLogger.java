...
public class FileLogger extends FileLoggerInterface {
    ...
    public static FileLogger getInstance() {
        if (null == singleton && context != null) {
            ...
            filePath = context.getFilesDir () + System.getProperty("file.separator") + LogPersister.FILENAME;
    ...
    public synchronized void log(final JSONObject logData, String fileName) throws SecurityException, IOException {
        if (null != singleton) {
            ...
            handler = new FileHandler(filePath, LogPersister.getMaxLogStoreSize(), LogPersister.MAX_NUM_LOG_FILES, true);
